...
export const metadata: Metadata = {
	title: 'Profile Page ',
	description: 'This is Profile page for Admin Next.js',
	// other metadata
}
		...
		<>
			...
			<div className='overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
				<div className='relative z-20 h-35 md:h-65'>
					<Image src={'/images/cover/cover-01.png'} alt='profile cover' className='h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-center' width={970} height={260} />
					<div className='absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4'>
						<label htmlFor='cover' className='flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4'>
				...
				<div className='px-4 pb-6 text-center lg:pb-8 xl:pb-11.5'>
					<div className='relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3'>
						<div className='relative drop-shadow-2'>
							<Image src={'/images/user/user-06.png'} width={160} height={160} alt='profile' />
