     ...
     <tbody>
      ...
      <tr className='grid grid-cols-7'>
       <td className='ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-25 md:p-6 xl:h-31'>
        ...
        <div className='group h-16 w-full flex-grow cursor-pointer py-1 md:h-30'>
         ...
         <div className='event invisible absolute left-2 z-1000 mb-1 flex w-[200%] flex-col rounded-sm border-l-[3px] border-primary bg-gray px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-meta-4 md:visible md:w-[190%] md:opacity-100'>
          <span className='event-name text-sm font-semibold text-black dark:text-white'>Redesign Website</span>
      ...
      <tr className='grid grid-cols-7'>
       ...
       <td className='ease relative h-20 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-25 md:p-6 xl:h-31'>
        ...
        <div className='group h-16 w-full flex-grow cursor-pointer py-1 md:h-30'>
         <span className='group-hover:text-primary md:hidden'>More</span>
         <div className='event invisible absolute left-2 z-1000 mb-1 flex w-[300%] flex-col rounded-sm border-l-[3px] border-primary bg-gray px-3 py-1 text-left opacity-0 group-hover:visible group-hover:opacity-100 dark:bg-meta-4 md:visible md:w-[290%] md:opacity-100'>
